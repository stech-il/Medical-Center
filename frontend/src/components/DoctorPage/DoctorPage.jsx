...
// const DoctorPage = () => {
//     const { id } = useParams();
//     const { currentPatient, nextPatient, moveRoom } = useRoomSocket(id);
//     const [roomData,setRoomData]=useState({});
...
//             try {
//                 const response = await getRoomById(id);
//                 setRoomData(response.data); // Assuming response.data contains the room data
//                 console.log(response.data);
//             } catch (error) {
//                 console.error('Error fetching room data:', error);
//             }
...
//                         <button onClick={() => moveRoom(1)} className='moveQueue'>
//                             <VaccinesIcon className='queueIcon' />
